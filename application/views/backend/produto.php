                                    ...
                                    <div class="modal-dialog modal-sm">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <h4>Deseja Excluir o Produto '.$produto->nomeproduto.'?</h4>
                                                <p>Após Excluida o Produto <b>'.$produto->nomeproduto.'</b> não ficara mais disponível no Sistema.</p>
                                                <p>Todos os itens relacionados ao Produto <b>'.$produto->nomeproduto.'</b> serão afetados e não aparecerão no site até que sejam editados.</p>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-default" data-dismiss="modal">Cancelar</button>
                                                <a type="button" class="btn btn-danger" href="'.base_url('admin/produto/excluir/'.md5($produto->idproduto)).'">Excluir</a>
                                            </div>
